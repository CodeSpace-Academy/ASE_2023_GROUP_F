...
const SearchBar = (props) => {
  ...
  const closeModal = () => {
	...
	return (
        ...
        <div className="flex items-center border border-gray-800 rounded-full p-2 m-1 min-w-[50px] bg-transparent">
  ...
  <select
    ...
    value={sortOption}
    onChange={handleSort}
    className="text-gray-800 outline-none border-none min-w-[50px] md:flex-grow bg-transparent"
  >
